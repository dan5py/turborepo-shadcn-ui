...
import app_banner from '@ui/assets/other/bum-app-banner.jpg'
const BumAppPage = () => {
    return (
        <div className='flex flex-col w-full gap-8 py-12 h-fit'>
            <div className="relative flex flex-col w-full pt-12 h-96 shrink-0">
                ...
                <Image src={app_banner} fill alt='app_banner' className='-z-10' />
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black via-transparent to-black">
                </div>
                <div className="absolute left-0 -z-[5] bottom-0 w-full h-0.5 bg-neutral-700"></div>
            </div>
            <ShotsWidget hideNav />
        </div>
    )
