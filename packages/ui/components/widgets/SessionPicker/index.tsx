...
const SessionPicker = () => {
    ...
    return (
        <div className='absolute z-50 flex flex-col w-full max-w-sm border top-3 right-3 h-fit rounded-xl border-neutral-700 bg-neutral-900'>
            <div className="relative flex items-center justify-between w-full px-4 py-2 border-b h-fit border-neutral-700">
                ...
                <Button onClick={() => setForcedClose(true)} size='icon' variant='ghost'><BiX size={20} /></Button>
            </div>
